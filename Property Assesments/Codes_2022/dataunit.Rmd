...
old <- read.csv("D:/BARI/Property Assesment/property2020.csv")
### INPUT PATHS ###
...
property_dt <- read.csv("D:/BARI/Property Assesment/data2021-full.csv") #177091
SAM_dt <- read.csv("D:/BARI/Property Assesment/Live_Street_Address_Management_(SAM)_Addresses.csv") #399198
############## preparing data
...
property_dt[property_dt$LU == "RL",]$unit_N_org <- 0
...
data_all <- A # this dataset has --- NA values of units- 177091 rows - we went from 23032 NAs to 5560
#data_all[76] <- NULL
#data_all[76] <- NULL
...
data_all$unit_N_org <- data_all$unit_N
...
k$unit_N <- 1000
write.csv(k, 'D:/BARI/Property Assesment/PA_outliers.csv', row.names= FALSE)
...
data_all[(is.na(data_all$unit_N) & (data_all$LU=='R4')),'unit_N'] <- as.integer(ceiling(glm_pred_r4))
...
#write.csv(data_all, "D:\\School\\summer 2021\\PAD.Record.wUnit05142021.csv", row.names=F)
write.csv(data_all_final, "D:/BARI/Property Assesment/PAD.Record.wUnit02122022.csv", row.names=F)
# > 100267/175004
# [1] 0.5729412
```
