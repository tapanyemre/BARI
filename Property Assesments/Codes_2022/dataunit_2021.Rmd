...
data_all <- subset(data_all, select = !(names(pa) %in% remove_columns))
```

```{r}
#names(data_all)[76] <- "unit_N"
data_all$unit_N_orig <- data_all$unit_N
...
#write.csv(data_all, "D:\\School\\summer 2021\\PAD.Record.wUnit02122022.csv", row.names=F)
# > 100267/175004
# [1] 0.5729412
```
