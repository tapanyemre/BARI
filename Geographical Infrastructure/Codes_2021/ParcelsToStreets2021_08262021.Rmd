...
parcels <-read.csv("G:/.shortcut-targets-by-id/0B_DORx3gdt5HZ1FOZF83VjJIVGs/BARI Research Team Data Library/Geographical Infrastructure/Boston Geographical Infrastructure 2021/Outputs/Parcel_final_2021_08172021.csv")
...
streets_prefinal <- read.csv("G:/.shortcut-targets-by-id/0B_DORx3gdt5HZ1FOZF83VjJIVGs/BARI Research Team Data Library/Geographical Infrastructure/Boston Geographical Infrastructure 2020/Outputs/Streets/roads_fin_clust_2020_08182020.csv")
...
length(unique(parcels$TLID)) #13836 (parcels from script 03) #13890 new #13885 in 2019 #13827 in 2020 #13833 in 2020 with changes #2021: 13817
...
streets_units<-aggregate(cbind(unit_N,property_N,!is.na(Land_Parcel_ID))~TLID,data=parcels,FUN=sum,na.rm=TRUE)
...
streets_prefinal <- streets_prefinal[,-c(22:24)]
streets_prefinal$X.1 <- NULL
streets_prefinal$X <- NULL
names(streets_prefinal)

names(streets_units)[4]<-'parcel_N'
...
summary(streets_prefinal) # 11056 streets is.na(streets_prefinal$unit_N) because 11056 street segments do not have parcels #11002 new #11007 in 2019 #11065 in 2020 #11059 in 2020 #11075 in 2021
...
streets_census<-merge(streets_tracts,streets_bgs,by='TLID',all.x=TRUE) #13832 streets_census #13886 new #13881 in 2019 #13823 in 2020 #13828 in fixed one # 13813 in 2021
...
View(streets_census[which(is.na(streets_census$BG_ID_10)),]) # the NA in BG is for TLID 636757439 and CT ID 25025040600 from streets census

# fixing the NA in BG
# read properties csv (this is output of script 03)
prop <- read.csv("G:/.shortcut-targets-by-id/0B_DORx3gdt5HZ1FOZF83VjJIVGs/BARI Research Team Data Library/Geographical Infrastructure/Boston Geographical Infrastructure 2021/Outputs/properties_geo_2021_08192021.csv")
...
length(setdiff(streets_census$BG_ID_10, streets_prefinal$BG_ID_10))
...
length(setdiff(streets_prefinal$BG_ID_10.y, streets_prefinal$BG_ID_10.x)) #1 #3
#setdiff(streets_census$BG_ID_10, streets_prefinal$BG_ID_10)
#setdiff(streets_census$CT_ID_10, streets_prefinal$CT_ID_10)
...
```{r}
# read streets as shapefile with geometry
roads <- st_read("G:\\.shortcut-targets-by-id\\0B_DORx3gdt5HZ1FOZF83VjJIVGs\\BARI Research Team Data Library\\Geographical Infrastructure\\Boston Geographical Infrastructure 2018\\Data\\BostonRoads2018\\Roads2018.shp")
...
st_write(streets_prefinal,"G:\\.shortcut-targets-by-id\\0B_DORx3gdt5HZ1FOZF83VjJIVGs\\BARI Research Team Data Library\\Geographical Infrastructure\\Boston Geographical Infrastructure 2021\\Outputs\\Streets\\roads_fin_2021_08262021.shp")

# export also as csv
write.csv(streets_prefinal,"G:\\.shortcut-targets-by-id\\0B_DORx3gdt5HZ1FOZF83VjJIVGs\\BARI Research Team Data Library\\Geographical Infrastructure\\Boston Geographical Infrastructure 2021\\Outputs\\Streets\\roads_fin_2021_08262021.csv", row.names = F)
