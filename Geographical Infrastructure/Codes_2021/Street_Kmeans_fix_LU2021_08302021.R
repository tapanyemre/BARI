...
parcel_final_2021_csv<-read.csv("../Outputs/Parcel_final_2021_08172021.csv")
...
streets_final <- st_read("../Outputs/Streets/roads_fin_2021_08262021.shp")
...
write.csv(streets_clust2,"../Outputs/Streets/roads_fin_clust_2021_08302021.csv")
