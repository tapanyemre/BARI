...
parcels <-read.csv("~/Desktop/BARI/GI-2023/drive/Parcel_final_10032023_YET.csv")
...
streets_prefinal <- streets_prefinal[,-c(22:25)]
...
summary(streets_prefinal) # 11056 streets is.na(streets_prefinal$unit_N) because 11056 street segments do not have parcels #11002 new #11007 in 2019 #11065 in 2020 #11059 in 2020 #11075 in 2021 #11026 in Sep 2023
...
#prop <- read.csv("properties_geo_2022_12132022.csv")
...
st_write(streets_prefinal,"roads_fin_clust_YET_10162023.shp")

# export also as csv
write.csv(streets_prefinal,"roads_fin_clust_YET_10162023.csv", row.names = F)
